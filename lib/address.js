...
Address.prototype.sign = function(hexString) {
    hexString = Buffer.isBuffer(hexString) ? hexString : Buffer.from(hexString, 'hex');

    secp256k1.sign(hexString, this.privateKey)
};
